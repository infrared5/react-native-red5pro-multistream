...
- (void)subscribe:(NSString *)streamName
    ...
    NSLog(@"(R5PRO) subscribe: streamName(%@), host(%@), withVideo(%@)", streamName, host, withVideo ? @"true" : @"false");
    dispatch_async(dispatch_get_main_queue(), ^{

        NSLog(@"(R5PRO) subscribe(2): streamName(%@), host(%@), withVideo(%@)", streamName, host, withVideo ? @"true" : @"false");
