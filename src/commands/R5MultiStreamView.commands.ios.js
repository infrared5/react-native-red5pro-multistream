...
export const publish = (handle, streamName, host, context, withVideo, width, height, streamType = R5PublishType.LIVE) => R5MultiStreamViewManager.publish(streamName, host, context, withVideo, width, height, streamType)
